...
class Cancel extends \Vnecoms\VendorsSales\Controller\Adminhtml\Sales\Order
{
    /**
    ...
    public function execute()
    {
        ...
        if ($order) {
            ...
            return $resultRedirect->setPath('vendors/sales_order/view', ['vorder_id' => $vendorOrder->getId()]);
        }
        return $resultRedirect->setPath('vendors/sales_order/');
    }
}
