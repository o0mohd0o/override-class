 ...
 */
namespace Vnecoms\VendorsSales\Controller\Adminhtml\Sales;
...
abstract class Order extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Vnecoms_VendorsSales::sales_order';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Vnecoms_VendorsSales::sales_order');
    ...
    {
        $id = $this->getRequest()->getParam('vorder_id');
        try {
            $order = $this->vendorOrderFactory->create()->load($id);
        ...
        $this->_coreRegistry->register('vendor_order', $order);
        return $order;
    }
