    ...
    protected function _initSelect()
    {
        ...
        $this->join(
            ...
            [
				...
				/*Fix to work with Amasty_Orderattribute*/
        $fromPart = $this->getSelect()->getPart('from');
        if(isset($fromPart['amorderattr'])){
            $orderAttrPart = $fromPart['amorderattr'];
            unset($fromPart['amorderattr']);
            $orderAttrPart['joinCondition'] = 'invoice_grid.order_id = amorderattr.parent_id';
            $fromPart['amorderattr'] = $orderAttrPart;
            $this->getSelect()->setPart('from', $fromPart);
        }
        /*End fix Amasty_Orderattribute*/
            return $this;
    }
}
