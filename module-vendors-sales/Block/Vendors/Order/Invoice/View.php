...
class View extends \Vnecoms\Vendors\Block\Vendors\Widget\Form\Container
{
    ...
    public function getEmailUrl()
    {
        return $this->getUrl(
            'sales/*/email',
            ['order_id' => $this->getInvoice()->getOrder()->getId(), 'invoice_id' => $this->getVendorInvoice()->getId()]
        );
    }
    ...
    public function getCreditMemoUrl()
    {
        return $this->getUrl(
            ...
            ['order_id' => $this->getVendorInvoice()->getOrder()->getId(), 'invoice_id' => $this->getVendorInvoice()->getId()]
        );
    }
