...
class History extends \Magento\Backend\Block\Template
{
     ...
     * @param \Magento\Sales\Model\ResourceModel\Order\Status\History\CollectionFactory $collectionFactory
     * @param array $data
     */
    ...
    {
        $state = $this->getVendorOrder()->getState();
        $statuses = $this->getConfig()->getStateStatuses($state);
        return $statuses;
    }
