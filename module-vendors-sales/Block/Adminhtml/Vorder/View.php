 ...
 */
namespace Vnecoms\VendorsSales\Block\Adminhtml\Vorder;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'vorder_id';
        $this->_controller = 'adminhtml_vorder';
        $this->_mode = 'view';
    ...
    {
        $_extOrderId = $this->getOrder()->getOrder()->getExtOrderId();
        if ($_extOrderId) {
        ...
        return __(
            'Order # %1 %2 | %3',
            $this->getOrder()->getOrder()->getRealOrderId(),
            $_extOrderId,
            $this->formatDate(
    ...
    {
        $params2['vorder_id'] = $this->getOrderId();
    ...
    {
        return $this->getUrl('vendors/sales_order/cancel');
    }
    ...
    {
        return $this->getUrl('vendors/sales_creditmemo/new');
    }
    ...
    {
        return $this->getUrl('vendors/sales_shipment/new');
    }
    ...
    {
        return $this->getUrl('vendors/sales_order/index');
    }
